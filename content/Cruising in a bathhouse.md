...
- Throughout each encounter, every participant needs to communicate that they are comfortable moving to the next stage. Or not.
### So, what are the ways to cruise in the baths?

- It starts with The Look if you can see each other
- If you're interested, it's smart to move toward the other person
	- If they move toward you, you have your first good sign
	- If they move away, that's the sign for you to move along
...
- In spaces with [[Glossary#Gloryhole|gloryholes]], [[Glossary#Sling|slings]], benches, and so on, choosing to participate is how interest and consent are communicated

#### Auntie says…

>You don't actually ever have to participate if you don't want to. It's perfectly fine to walk around, watch what's happening -- and maybe even leave without touching another person. Be you. Do what feels right, good, and fun *for you.*
...
- If you get the sense that they're into the idea (or at least not against it), try touching one of them lightly (chest, leg, arm, just like [[#So, what are the ways to cruise in the baths?|the gentle touches]] described above)
