...
With the arrival of [Sniffies](https://sniffies.com/join/63dee15e69a7d9001c45111c) and its dynamic, live map, bathhouses become part of the digital cruising landscape in a way that they haven't before: They become *fixed locations* where people are actively hooking up -- what Sniffies calls "Places" on their map. We can see if there might be a crowd there and use that information to help us decide whether to go.
...
- The "wall" of messages on each Place
	- allows newer folks to learn about a place before their first visit
	- and allows the rest of us a chance to chat with others who might visit when we do
